...
namespace UniversityProjectVovk.Functional1
{
    public partial class AWorkerForm1 : APeopleForm1
    {
        ...
        private void AWorkerForm1_Load(object sender, EventArgs e)
        {
            ...
            string queryString = "SELECT StartTime, EndTime, Place, Sallary FROM dbo.Assignment INNER JOIN dbo.AWorker ON dbo.Assignment.Id = dbo.AWorker.Id  where OwnerId = '" + (node.Tag as NodeData).Object.Id + "';";
